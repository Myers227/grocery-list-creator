...
public class MainPageController {
    ...
    // Method to control theme change. Still a work in progress.
    @FXML
    private void handleThemeChange() {
        ...
        // Remove all stylesheets before applying a new one
        scene.getStylesheets().clear();

        // Apply the correct stylesheet based on the ComboBox selection
        if (selectedTheme.equals("Red Theme")) {
            scene.getStylesheets().add(getClass().getResource("/css/red-theme.css").toExternalForm());
        } else if (selectedTheme.equals("Green Theme")) {
            scene.getStylesheets().add(getClass().getResource("/css/green-theme.css").toExternalForm());
        } else if (selectedTheme.equals("Blue Theme")) {
            scene.getStylesheets().add(getClass().getResource("/css/blue-theme.css").toExternalForm());
        }
    }
